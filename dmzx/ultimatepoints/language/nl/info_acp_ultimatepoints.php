...
$lang = array_merge($lang, array(
	...
	'FORUM_PERTOPIC'					=> 'Punten per topic',
	'FORUM_PERTOPIC_EXPLAIN'			=> 'Vul hier in hoeveel punten gebruikers zullen ontvangen voor het plaatsen van <strong>nieuwe topic</strong>. Houd er rekening mee dat ze ook extra punten zullen ontvangen die u hebt bepaald in de geavanceerde instellingen voor de punten.<br />Zet op 0 voor het ontvangen van punten uit te schakelen voor dit forum. Op deze manier zijn ook de geavanceerde punten instellingen uitgeschakeld voor dit forum.',
	...
	'FORUM_COST_TOPIC'					=> 'Punten te betalen voor een nieuwe topic',
	'FORUM_COST_TOPIC_EXPLAIN'			=> 'Vul hier in hoeveel punten gebruikers dienen te betalen om een nieuwe topic te starten in dit forum',
	...
	'POINTS_BONUS_CHANCE_EXPLAIN'		=> 'De kans dat een gebruiker bonus punten ontvangt voor het maken van een nieuw topic, bericht of bewerking.<br />Kansen zijn tussen 0 en 100%. U kunt decimalen gebruiken.<br />Zet op <strong>0</strong> om deze functie uit te schakelen.',
	...
	'POINTS_GROUP_TRANSFER_PM_SUCCESS'	=> 'De groep overschrijving werd succesvol uitgevoerd en<br />de leden van de groep hebben je persoonlijke berocht ontvangen.',
	...
	'POINTS_TOPIC_PER_CHARACTER'		=> 'Punten per karakter in nieuwe topics',
	'POINTS_TOPIC_PER_WORD'				=> 'Punten per woord in nieuwe topics',
	...
	'POINTS_TRANSFER_FEE'				=> 'Overschrijvings kosten',
	'POINTS_TRANSFER_FEE_EXPLAIN'		=> 'Percentage dat ingehouden wordt per overschrijving',
	'POINTS_TRANSFER_FEE_ERROR'			=> 'Overschrijvings kosten kunnen geen 100% of meer zijn.',
