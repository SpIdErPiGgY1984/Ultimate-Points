...
$lang = array_merge($lang, array(
	...
	'INFO_BONUS_CHANCE_EXPLAIN'			=> 'Je hebt momenteel %1$s &#37; kans om een bonus toename te krijgen van %2$s naar %3$s %4$s',
	...
	'INFO_TOPIC_WORD'					=> 'Punten per woord in een nieuwe topic',
	'INFO_TOPIC_CHARACTER'				=> 'Punten per karakter in een nieuwe topic',
	...
	'POINTS_INFO_DESCRIPTION'			=> 'Hier zal je meer informatie vinden over ons %1$s beleid.<br /><br />In aanvulling van deze waarden kunt u extra %1$s ontvangen in bepaalde topics.<br /><br />Houd u er aub rekening mee dat de forum eigenaar de mogelijkheid heeft om volledige forums uit te sluiten om %1$s te ontvangen!',
	'POINTS_INSUFFICIENT_POST'			=> 'Je hebt niet voldoende %2$s om een bericht te maken in deze topic. De kosten om een bericht te maken in dit forum zijn <strong>%1$s %2$s</strong>.',
	'POINTS_INSUFFICIENT_TOPIC'			=> 'Je hebt niet voldoende %2$s om een nieuwe topic te maken in dit forum. De kosten om een topic te maken in dit forum zijn <strong>%1$s %2$s</strong>.',
	...
	'POINTS_LOTTERY_TIME'				=> 'Volgende loterij trekking: %1$s',
	'POINTS_MODIFY'						=> '[Bewerk]',
	'POINTS_MOST_RICH_CASH_USERS'		=> 'Gebruikers met het meeste cash',
	'POINTS_MOST_RICH_USERS'			=> 'Rijkste gebruiker',
	...
	'POINTS_RECEIVED_POST_MESSAGE'		=> 'Je ontving <strong>%1$s %2$s</strong> voor je nieuwe topic',
